...
First we will load our proboscidean occurrence data. This is located in the repository for the workshop, and can be downloaded from the GitHub (remember to adjust the path).
